...
public final class Orderbook {
    ...
    public Orderbook(@JsonProperty(value = "figi", required = true)
                     ...
                     @NotNull final List<Item> bids,
                     @JsonProperty(value = "asks", required = true)
                     @NotNull final List<Item> asks,
                     @JsonProperty(value = "tradeStatus", required = true)
                     @NotNull final TradeStatus tradeStatus,
                     @JsonProperty(value = "minPriceIncrement", required = true)
                     @NotNull final BigDecimal minPriceIncrement,
                     @JsonProperty("faceValue")
                     @Nullable final BigDecimal faceValue,
                     @JsonProperty("lastPrice")
                     @Nullable final BigDecimal lastPrice,
                     @JsonProperty("closePrice")
                     @Nullable final BigDecimal closePrice,
