...
public final class PlacedOrder {
    ...
    public PlacedOrder(@JsonProperty(value = "orderId", required = true)
                       ...
                       @Nullable final String rejectReason,
                       @JsonProperty(value = "message")
                       @Nullable final String message,
                       @JsonProperty(value = "requestedLots", required = true) final int requestedLots,
                       @JsonProperty(value = "executedLots", required = true) final int executedLots,
