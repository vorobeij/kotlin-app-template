...
public final class Portfolio {
    ...
    public Portfolio(@JsonProperty("positions")
                     @NotNull final List<PortfolioPosition> positions) {
    ...
    public final static class PortfolioPosition {
        ...
        public PortfolioPosition(@JsonProperty(value = "figi", required = true)
                                 ...
                                 @JsonProperty("ticker")
                                 @Nullable final String ticker,
                                 @JsonProperty("isin")
                                 @Nullable final String isin,
                                 @JsonProperty(value = "instrumentType", required = true)
                                 @NotNull final InstrumentType instrumentType,
                                 ...
                                 @Nullable final MoneyAmount expectedYield,
                                 @JsonProperty("lots") final int lots,
                                 @JsonProperty("averagePositionPrice")
                                 @Nullable final MoneyAmount averagePositionPrice,
                                 @JsonProperty("averagePositionPriceNoNkd")
                                 @Nullable final MoneyAmount averagePositionPriceNoNkd,
        ...
        public String toString() {
            ...
            if (Objects.nonNull(averagePositionPrice))
                sb.append(", averagePositionPrice=").append(averagePositionPrice);
            if (Objects.nonNull(averagePositionPriceNoNkd))
                sb.append(", averagePositionPriceNoNkd=").append(averagePositionPriceNoNkd);
