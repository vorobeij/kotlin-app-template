...
import io.swagger.client.models.SandboxRegisterRequest
import io.swagger.client.models.SandboxRegisterResponse
import io.swagger.client.models.SandboxSetCurrencyBalanceRequest
import io.swagger.client.models.SandboxSetPositionBalanceRequest
...
class SandboxApi(basePath: kotlin.String = "https://api-invest.tinkoff.ru/openapi/") : ApiClient(basePath) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun sandboxCurrenciesBalancePost(body: SandboxSetCurrencyBalanceRequest, brokerAccountId: kotlin.String? = null): Empty {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun sandboxPositionsBalancePost(body: SandboxSetPositionBalanceRequest, brokerAccountId: kotlin.String? = null): Empty {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf("brokerAccountId" to listOf("$brokerAccountId"))
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
